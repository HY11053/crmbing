                        ...
                        <div class="timeline-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::select('gender', ['男','女'], null,array('class'=>'form-control select2','style'=>'width: 100%'))}}
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                        {{Form::select('package', $advertisements, null,array('class'=>'form-control select2','style'=>'width: 100%'))}}
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    {{Form::label('wedding', '婚期时间', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                    <div class="input-group date  col-md-8 col-sm-9 col-xs-12" style="padding-left: 15px;">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        {{Form::text('wedding', null, array('class' => 'form-control pull-right','id'=>'datepicker','placeholder'=>'点击选择婚期时间','style'=>'width:100%'))}}
                                    </div>
                                </div>
                            </div>
                        </div>
