@extends('admin.admin')
@section('title')门店接待客户信息编辑 @stop
@section('position') <li class="active">门店接待客户信息编辑</li> @stop
@section('headlibs')
...
@section('content')
    <div class="row">
        {{Form::model($thiscunstomdata,array('route' =>array('visitdataedit', $thiscunstomdata->id)))}}
        <div class="col-md-12">
            <!-- The time line -->
